           ...
           <div class="col-md-12">
               ...
               <form action="{{ route('events.update', $event->id) }}" method="POST" enctype="multipart/form-data">
                   ...
                   <div class="form-group">
                       ...
                       <textarea class="form-control" id="intro" name="intro" rows="3" required>{{ $event->intro }}</textarea>
                   </div>
                   ...
                   <div class="form-group">
                       <label for="img">Main Image (16:9)</label>
                       <input type="file" class="form-control" id="img" name="img">
                   </div>
   
                   <div class="form-group">
                       <label for="img2">Second Event Image (16:9)</label>
